...
- **Tranche 1 EN COURS (2026-09-04/05, suites 43–44)** : une invocation
  ...
  au journal (suite 44).
  - Jeux joués (8/25, chacun : RHAE 0,00, arrêt au plafond de temps 1 200 s,
  ...
  - **Prochaine session : reprendre au jeu 9/25, `ft09-0d8bbf25`**, puis les
    non-joués dans l'ordre du jour du journal (suite 44) :
    `ls20-9607627b`, `tu93-0768757b`,
