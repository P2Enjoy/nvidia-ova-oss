...
|---|---|---|---|---|---|
| `tn36-ef4dde99` | 0 / 7 | 22 | 317 | 0.00 | budget de temps du jeu épuisé (2400.0 s) |

## Détail par niveau

| Jeu | Niveau | Baseline hₗ | Actions aₗ | Complété | Poids wₗ |
|---|---|---|---|---|---|
| `tn36-ef4dde99` | 1 | 32 | 22 | non | 1 |
...
- appels au modèle : **29**
- tokens de prompt : **283090**
- tokens générés : **11930**
- durée d'inférence cumulée : **1133.82 s**
- actions dépensées : **22**
- tours joués : **27**
- durée cumulée de jeu : **2493.32 s**
...
- Scorecard de la campagne : `5198dcc6-67f9-4a5a-9485-df36325bcd45`.
