...
|---|---|---|---|---|---|
| `tu93-0768757b` | 0 / 9 | 36 | 462 | 0.00 | budget de temps du jeu épuisé (1200.0 s) |

## Détail par niveau

| Jeu | Niveau | Baseline hₗ | Actions aₗ | Complété | Poids wₗ |
|---|---|---|---|---|---|
| `tu93-0768757b` | 1 | 19 | 36 | non | 1 |
...
- appels au modèle : **40**
- tokens de prompt : **363728**
- tokens générés : **22215**
- durée d'inférence cumulée : **1155.97 s**
- actions dépensées : **36**
- tours joués : **40**
- durée cumulée de jeu : **1200.04 s**
...
- Scorecard de la campagne : `1e13bc47-0172-43ea-9738-edb588c4020c`.
