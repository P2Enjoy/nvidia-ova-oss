...
|---|---|---|---|---|---|
| `tu93-0768757b` | 0 / 9 | 10 | 462 | 0.00 | budget de temps du jeu épuisé (1200.0 s) |

## Détail par niveau

| Jeu | Niveau | Baseline hₗ | Actions aₗ | Complété | Poids wₗ |
|---|---|---|---|---|---|
| `tu93-0768757b` | 1 | 19 | 10 | non | 1 |
...
- appels au modèle : **41**
- tokens de prompt : **376333**
- tokens générés : **20213**
- durée d'inférence cumulée : **1225.64 s**
- actions dépensées : **10**
- tours joués : **38**
- durée cumulée de jeu : **1256.57 s**
...
- Scorecard de la campagne : `96ffae3c-f1c3-4efe-8d7c-ebb119871b02`.
